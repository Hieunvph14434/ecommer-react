...
const ProductDetailsComponent = () => {
    ...
    return (
        <>
            <h1 className='text-[24px] font-[600] mb-2'>Ethnic Motifs Embroidered Thread Work Pure Cotton Kurta with Trousers & Dupatta</h1>
            <div className='flex items-center gap-3'>
                <span className='text-gray-400 text-[13px]'>
                    Brands :{" "}
                    <span className='font-[500] text-black opacity-75'>Indo Era</span>
                </span>
            ...
            <div className='flex items-center gap-4 mt-4'>
                ...
                <span className='price text-primary text-[20px] font-[600]'>$58.00</span>
                <span className='text-[14px]'>
                    Available In Stock:{" "}
                    <span className='text-[14px] text-green-600 font-bold'>147 Items</span>
                </span>
            </div>
